function funcy() {
    ...
    document.getElementById('listy').style.opacity = 0;
    document.getElementById('listy').style.zIndex = -1;
};
function funcx() {
    document.getElementById('listy').style.visibility = "visible";
    document.getElementById('listy').style.opacity = 1;
    document.getElementById('listy').style.zIndex = 22;
};
